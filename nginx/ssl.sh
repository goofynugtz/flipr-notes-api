...
certbot --nginx --non-interactive --agree-tos -d rahul-api.sr.flipr.ai -d rahul-grafana.sr.flipr.ai -d rahul-jenkins.sr.flipr.ai --register-unsafely-without-email
